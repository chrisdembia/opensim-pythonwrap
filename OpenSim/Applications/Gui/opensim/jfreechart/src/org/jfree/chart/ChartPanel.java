...
public class ChartPanel extends JPanel 
    ...
    /** Print action command. */
    public static final String PRINT_POSTSCRIPT_COMMAND = "PRINT_PS";
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        else if (command.equals(PRINT_POSTSCRIPT_COMMAND)) {
            createChartPrintPostScriptJob();
        }
    ...
    protected JPopupMenu createPopupMenu(boolean properties, 
        ...
        if (print) {
            ...
            printPostScriptItem.addActionListener(this);
            result.add(printPostScriptItem);
            separator = true;
        }
