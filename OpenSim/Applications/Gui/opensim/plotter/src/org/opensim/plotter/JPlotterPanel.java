...
public class JPlotterPanel extends javax.swing.JPanel
    ...
    private void initComponents() {
        ...
        jClampToTextField1 = new javax.swing.JTextField();
        ...
        jClampToTextField1.addActionListener(this);
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .add(jPanel10Layout.createSequentialGroup()
                ...
                .add(jLabel1)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jClampFromTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 55, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jLabel3)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jClampToTextField1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 62, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            ...
            .add(jPanel10Layout.createSequentialGroup()
                .add(yQuantityButton)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jYQtyTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE))
        );
        jPanel10Layout.setVerticalGroup(
            ...
            .add(jPanel10Layout.createSequentialGroup()
                ...
                .add(jPanel10Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(jLabel3)
                    .add(jClampToTextField1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(0, 0, 0))
        );
            ...
            .add(jPlotSpecPanelLayout.createSequentialGroup()
                .add(jPlotSpecPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPlotSpecPanelLayout.createSequentialGroup()
                        ...
                        .add(22, 22, 22)
                        .add(jCurveNameTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE))
        ...
        jPlotTitlePanelLayout.setHorizontalGroup(
            ...
            .add(jPlotTitlePanelLayout.createSequentialGroup()
                ...
                .add(22, 22, 22)
                .add(jPlotNameTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        else if (evt.getSource() == jClampToTextField1) {
            JPlotterPanel.this.jClampToTextField1ActionPerformed(evt);
        }
...
// TODO add your handling code here:
        if (sourceY instanceof PlotterSourceAnalysis){
            ...
            System.out.println("motionSources size="+motionSources.size());
            for(int i=0; i<motionSources.size(); i++){
                ...
                motionMenuItem.addActionListener(new ActionListener(){
                    public void actionPerformed(ActionEvent e) {
                        domainName=nextMotion.getDisplayName();
                    }
                });
...
// TODO add your handling code here:
   ...
   private void jClampToTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jClampToTextField1ActionPerformed
// TODO add your handling code here:
   }//GEN-LAST:event_jClampToTextField1ActionPerformed
...
// TODO add your handling code here:
   ...
   private PlotCurveSettings getSettings() {
    ...
    private javax.swing.JTextField jClampToTextField1;
...
/*      try {
    ...
    void runAnalysisTool() {
        ...
        if (domainName.startsWith("Motion")){
            //tool.setStatesStorage(plotterModel);
        }
        else {
            ...
            sourceX=new PlotterSourceAnalysis(currentModel, statesStorage, "MODEL_STATES");
        }
                ...
                for(int storageIndex=0; storageIndex<storages.getSize(); storageIndex++){
                    ...
                    quantityMenuItem.addActionListener(
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            DialogDescriptor dlg = new DialogDescriptor(filterpanel,"Select Y Quantity");
                            dlg.setModal(true);
