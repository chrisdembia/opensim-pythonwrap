...
public final class ScalingVisualPanel extends workflowVisualPanelBase {
   ...
   private void initComponents() {
      ...
      scaleMethodSelect.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "manualScale", "measurements", "manualScale+measurements", "measurements+manualScale" }));
