...
// TODO add your handling code here:
        ...
        if (dlog.showOpenDialog((JFrame) WindowManager.getDefault().getMainWindow()) == JFileChooser.APPROVE_OPTION && dlog.getSelectedFile() != null) {
            ...
            try {
               ik = new IKTool(jSetupFilenameTextField.getText(), false);
               ik.setModel(logicPanel.descriptor.getIKModel()); 
...
// TODO add your handling code here:
    ...
    void updatePanel(WorkflowDescriptor aDescriptor) {
        ...
        if (filename != null){
           try {
             ik = new IKTool(filename, false);
             ik.setModel(aDescriptor.getIKModel());
           } catch(IOException ex) {}
        }
