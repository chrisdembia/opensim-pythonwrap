/*
 * CommonScalePanel.java
 *
 * Created on September 6, 2006, 2:03 PM
 */
 ...
 *
 * @author  Ayman
 * A Scaling panel to be used by the separate "Scaling tool" and by the workflow wizard
 */
public class CommonScalePanel extends javax.swing.JPanel {
    
    private ArrayStr scalingOrder;
    /** Creates new form CommonScalePanel */
    public CommonScalePanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        scaleMethodSelect.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                scaleMethodSelectScalingMethodSelectionHandler(evt);
            }
        });
        ...
        markerTrialTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                markerTrialTextFieldActionPerformed(evt);
            }
        });
        ...
        jEditScalesButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jEditScalesButtonActionPerformed(evt);
            }
        });
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jOutputPanelLayout.createSequentialGroup()
                .add(jOutputPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jOutputPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jOutputPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(saveSIMMJntTextField1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
                            .add(saveSIMMmslTextField1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)))
                    .add(jOutputPanelLayout.createSequentialGroup()
                        .add(jCheckBoxSaveopensim1)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(saveOpenSimTextField1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)))
                .add(jOutputPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jOutputPanelLayout.createSequentialGroup()
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jManualScalePanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(jMeasurementScalePanel, 0, 311, Short.MAX_VALUE)
    ...
    private void jEditScalesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditScalesButtonActionPerformed
// TODO add your handling code here:
    }//GEN-LAST:event_jEditScalesButtonActionPerformed

    private void markerTrialTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_markerTrialTextFieldActionPerformed
// TODO add your handling code here:
    }//GEN-LAST:event_markerTrialTextFieldActionPerformed
    ...
    private void jBrowse4Msl1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBrowse4Msl1ActionPerformed
        ...
        userWorkingDirectory = Preferences.userNodeForPackage(TheApp.class).get("WorkDirectory", userWorkingDirectory);
        final JFileChooser dlog = new JFileChooser(userWorkingDirectory);
...
// TODO add your handling code here:
    ...
    private void jBrowse4Jnt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBrowse4Jnt1ActionPerformed
        String userWorkingDirectory="";
        userWorkingDirectory = Preferences.userNodeForPackage(ViewDB.getInstance().getClass()).get("WorkDirectory", userWorkingDirectory);
        final JFileChooser dlog = new JFileChooser(userWorkingDirectory);
        if (dlog.showOpenDialog(null) == JFileChooser.APPROVE_OPTION && dlog.getSelectedFile() != null) {
...
// TODO add your handling code here:
    ...
    private void jBrowse4ScaleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBrowse4ScaleButtonActionPerformed
        ...
        if (dlog.showOpenDialog(null) == JFileChooser.APPROVE_OPTION && dlog.getSelectedFile() != null) {
            String manualScaleFile= dlog.getSelectedFile().getAbsolutePath();
            scaleMethodSelect.setSelectedItem("manual");
            jManualScaleTextField.setText(manualScaleFile);
            // Now update the workflow descriptor
        }
...
// TODO add your handling code here:
    ...
    private void scaleMethodSelectScalingMethodSelectionHandler(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scaleMethodSelectScalingMethodSelectionHandler
// TODO add your handling code here:
    ...
    }//GEN-LAST:event_scaleMethodSelectScalingMethodSelectionHandler
    ...
    /**
     * Update GUI based on the object passed in
     */
    void readFrom(SimmScalingParams scalingParams) {
        ...
        ArrayStr scalingOrder = scalingParams.getScalingOrder();
        ...
        String userWorkingDirectory="";
        userWorkingDirectory = Preferences.userNodeForPackage(ViewDB.getInstance().getClass()).get("WorkDirectory", userWorkingDirectory);
        String subjectPath = userWorkingDirectory;
       // if OutputModelFileName is null we should use ours
        if (!scalingParams.getOutputModelFileName().equalsIgnoreCase("Unassigned")){
            ...
            saveOpenSimTextField1.setText(subjectPath+
        ...
        if (!scalingParams.getOutputJointFileName().equalsIgnoreCase("Unassigned")){
            ...
            saveSIMMJntTextField1.setText(subjectPath+
                                            FileUtils.addSuffix(madeUpName,"SP"));
        }
        // Muscle file
        if (!scalingParams.getOutputMuscleFileName().equalsIgnoreCase("Unassigned")){
            ...
            saveSIMMmslTextField1.setText(subjectPath+
                                            FileUtils.addSuffix(madeUpName,"SP"));
        }
        repaint();
    }
    /**
     * update Object based on current GUI values
     *
     * @todo Write these individual validation error messages to a text pane to avoid too many popups.
     **/
    void writeTo(SimmScalingParams scalingParams) {
       String order = (String)scaleMethodSelect.getSelectedItem();
        ...
        if (includesManual){    // Make sure a scale file has been selected
            if(jManualScaleTextField.getText().equals("")){
                ...
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Setting Scales is not implemented yet, pending resolution of bug 209."));
        ...
        if (includesMeasurements){    // Make sure a scale file has been selected
            if(jManualScaleTextField.getText().equals("")){
                ...
                // Create a ScaleSet based on selected file and set it in Subject.
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Setting MEasurements is not implemented yet, pending resolution of bug 209."));
            }
            if (ValidateUserInput.validateFileExists(markerTrialTextField.getText(), true, false, true))
                scalingParams.setMarkerFileName(markerTrialTextField.getText());
            else 
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("trc file name is invalid or the file does not exist."));
             if (ValidateUserInput.validateDoubleRange(jFromTimeTextField.getText(),
                    jToTimeTextField.getText(), true)){
                ArrayDouble timeRange = new ArrayDouble(2);
                timeRange.setitem(0, Double.parseDouble(jFromTimeTextField.getText()));
                timeRange.setitem(1, Double.parseDouble(jToTimeTextField.getText()));
                scalingParams.setTimeRange(timeRange);
             }
             else 
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Invalid time range specified for the static trial file."));
            
            if (jSaveScalesCheckBox.getModel().isSelected()){
                // Validate a Scales file has been specified
                 if (ValidateUserInput.validateFileExists(saveScalesTextField.getText(), false, false, true))
                    scalingParams.setOutputScaleFileName(saveScalesTextField.getText());
                else 
                    DialogDisplayer.getDefault().notify(
                        new NotifyDescriptor.Message("scales file name is invalid."));
            }
       }
        // Now output files
        if (jCheckBoxSaveopensim1.getModel().isSelected()){
            // Validate a file has been specified
             if (ValidateUserInput.validateFileExists(saveOpenSimTextField1.getText(), false, false, true))
                scalingParams.setOutputModelFileName(saveOpenSimTextField1.getText());
            else 
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Output opensim file name is invalid."));
        }
        if (jCheckBox2.getModel().isSelected()){
            // Validate a file has been specified
             if (ValidateUserInput.validateFileExists(saveSIMMJntTextField1.getText(), false, false, true))
                scalingParams.setOutputJointFileName(saveSIMMJntTextField1.getText());
            else 
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Output SIMM jnt file name is invalid."));
        }
        if (jCheckBoxSavemsl1.getModel().isSelected()){
            // Validate a file has been specified
             if (ValidateUserInput.validateFileExists(saveSIMMmslTextField1.getText(), false, false, true))
                scalingParams.setOutputMuscleFileName(saveSIMMmslTextField1.getText());
            else 
                DialogDisplayer.getDefault().notify(
                    new NotifyDescriptor.Message("Output SIMM msl file name is invalid."));
        }
        
    }
    /**
     * Parse a srting from the sclingOrder drop down into a StrArr to be used by the object
     **/
