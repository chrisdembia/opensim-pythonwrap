...
public class ForceSet extends ModelComponentSetForces {
  ...
  public void createForcesFromFile(String datafileName, ArrayStr startForceColumns, ArrayInt columnCount, ArrayStr bodyNames) {
    opensimModelJNI.ForceSet_createForcesFromFile(swigCPtr, this, datafileName, ArrayStr.getCPtr(startForceColumns), startForceColumns, ArrayInt.getCPtr(columnCount), columnCount, ArrayStr.getCPtr(bodyNames), bodyNames);
  }

  public String getDataFileName() {
    return opensimModelJNI.ForceSet_getDataFileName(swigCPtr, this);
  }

  public void setDataFileName(String aNewFile) {
    opensimModelJNI.ForceSet_setDataFileName(swigCPtr, this, aNewFile);
  }
