...
public class Storage extends StorageInterface {
  ...
  public Function createUnivariateFunction(String range, String interpolationScheme, ArrayDouble extraData, String domain) {
    long cPtr = opensimModelJNI.Storage_createUnivariateFunction__SWIG_0(swigCPtr, this, range, interpolationScheme, ArrayDouble.getCPtr(extraData), extraData, domain);
    return (cPtr == 0) ? null : new Function(cPtr, false);
  }

  public Function createUnivariateFunction(String range, String interpolationScheme, ArrayDouble extraData) {
    long cPtr = opensimModelJNI.Storage_createUnivariateFunction__SWIG_1(swigCPtr, this, range, interpolationScheme, ArrayDouble.getCPtr(extraData), extraData);
    return (cPtr == 0) ? null : new Function(cPtr, false);
  }
