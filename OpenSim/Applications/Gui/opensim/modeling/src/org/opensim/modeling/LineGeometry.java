...
public class LineGeometry extends Geometry {
  ...
  public void getPoints(double[] rPoint1, double[] rPoint2) {
    opensimModelJNI.LineGeometry_getPoints(swigCPtr, rPoint1, rPoint2);
  }

  public void setPoints(double[] aPoint1, double[] aPoint2) {
    opensimModelJNI.LineGeometry_setPoints(swigCPtr, aPoint1, aPoint2);
  }

  public static LineGeometry dynamic_cast(Geometry geometry) {
    long cPtr = opensimModelJNI.LineGeometry_dynamic_cast(Geometry.getCPtr(geometry));
