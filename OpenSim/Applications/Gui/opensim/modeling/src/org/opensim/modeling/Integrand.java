...
public class Integrand extends OpenSimObject {
  ...
  public int getSize() {
    return opensimModelJNI.Integrand_getSize(swigCPtr, this);
  }

  public void setInitialStates(double ti, double[] yi) {
    opensimModelJNI.Integrand_setInitialStates(swigCPtr, this, ti, yi);
  }

  public void getInitialStates(double[] yi) {
    opensimModelJNI.Integrand_getInitialStates(swigCPtr, this, yi);
  }

  public void compute(double t, double[] y, double[] dydt) {
    opensimModelJNI.Integrand_compute(swigCPtr, this, t, y, dydt);
  }

  public void computeJacobian(double t, double[] y, SWIGTYPE_p_double dydtdy) {
    opensimModelJNI.Integrand_computeJacobian(swigCPtr, this, t, y, SWIGTYPE_p_double.getCPtr(dydtdy));
  }

  public void initialize(int step, SWIGTYPE_p_double dt, double ti, double tf, double[] y) {
    opensimModelJNI.Integrand_initialize(swigCPtr, this, step, SWIGTYPE_p_double.getCPtr(dt), ti, tf, y);
  }

  public void processAfterStep(int step, SWIGTYPE_p_double dt, double t, double[] y) {
    opensimModelJNI.Integrand_processAfterStep(swigCPtr, this, step, SWIGTYPE_p_double.getCPtr(dt), t, y);
  }

  public void finalize(int step, double t, double[] y) {
    opensimModelJNI.Integrand_finalize(swigCPtr, this, step, t, y);
  }
