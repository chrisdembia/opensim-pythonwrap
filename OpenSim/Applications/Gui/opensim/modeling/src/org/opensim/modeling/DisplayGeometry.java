...
public class DisplayGeometry extends OpenSimObject {
  ...
  public OpenSimObject copy() {
    long cPtr = opensimModelJNI.DisplayGeometry_copy(swigCPtr, this);
  ...
  public final static class DisplayPreference {
    public final static DisplayPreference None = new DisplayPreference("None", opensimModelJNI.DisplayGeometry_None_get());
    public final static DisplayPreference WireFrame = new DisplayPreference("WireFrame", opensimModelJNI.DisplayGeometry_WireFrame_get());
    public final static DisplayPreference SolidFill = new DisplayPreference("SolidFill", opensimModelJNI.DisplayGeometry_SolidFill_get());
    public final static DisplayPreference FlatShaded = new DisplayPreference("FlatShaded", opensimModelJNI.DisplayGeometry_FlatShaded_get());
    public final static DisplayPreference GouraudShaded = new DisplayPreference("GouraudShaded", opensimModelJNI.DisplayGeometry_GouraudShaded_get());
