...
public class IKCoordinateTask extends IKTask {
  ...
  public final static class ValueType {
    public final static ValueType DefaultValue = new ValueType("DefaultValue");
    public final static ValueType ManualValue = new ValueType("ManualValue");
    public final static ValueType FromFile = new ValueType("FromFile");
