...
public class IndAcc extends Analysis {
  ...
  public IndAcc(AbstractModel aModel) {
    this(opensimModelJNI.new_IndAcc__SWIG_0(AbstractModel.getCPtr(aModel)), true);
  }

  public IndAcc(AbstractModel aModel, Storage aStates, Storage aControls, String aBaseName, String aDir, String aExtension) {
    this(opensimModelJNI.new_IndAcc__SWIG_1(AbstractModel.getCPtr(aModel), Storage.getCPtr(aStates), Storage.getCPtr(aControls), aBaseName, aDir, aExtension), true);
  }

  public IndAcc(AbstractModel aModel, Storage aStates, Storage aControls, String aBaseName, String aDir) {
    this(opensimModelJNI.new_IndAcc__SWIG_2(AbstractModel.getCPtr(aModel), Storage.getCPtr(aStates), Storage.getCPtr(aControls), aBaseName, aDir), true);
  }

  public IndAcc(AbstractModel aModel, Storage aStates, Storage aControls, String aBaseName) {
    this(opensimModelJNI.new_IndAcc__SWIG_3(AbstractModel.getCPtr(aModel), Storage.getCPtr(aStates), Storage.getCPtr(aControls), aBaseName), true);
  }
