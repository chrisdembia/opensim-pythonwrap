...
public class PiecewiseConstantFunction extends Function {
  ...
  public double calcValue(SWIGTYPE_p_SimTK__Vector x) {
    return opensimModelJNI.PiecewiseConstantFunction_calcValue(swigCPtr, this, SWIGTYPE_p_SimTK__Vector.getCPtr(x));
  }

  public double calcDerivative(SWIGTYPE_p_std__vectorT_int_t derivComponents, SWIGTYPE_p_SimTK__Vector x) {
    return opensimModelJNI.PiecewiseConstantFunction_calcDerivative(swigCPtr, this, SWIGTYPE_p_std__vectorT_int_t.getCPtr(derivComponents), SWIGTYPE_p_SimTK__Vector.getCPtr(x));
  }
