...
public class Transform {
  ...
  public Transform copy() {
    long cPtr = opensimModelJNI.Transform_copy(swigCPtr, this);
  ...
  public void getOrientation(SWIGTYPE_p_a_3__double rOrientation) {
    opensimModelJNI.Transform_getOrientation(swigCPtr, this, SWIGTYPE_p_a_3__double.getCPtr(rOrientation));
  }

  public void setOrientation(SWIGTYPE_p_a_3__double aOrientation) {
    opensimModelJNI.Transform_setOrientation(swigCPtr, this, SWIGTYPE_p_a_3__double.getCPtr(aOrientation));
  }

  public void setIdentity() {
    opensimModelJNI.Transform_setIdentity(swigCPtr, this);
  }

  public void rotate(double[] r, Transform.AnglePreference preference, Transform.RotationOrder order) {
    opensimModelJNI.Transform_rotate(swigCPtr, this, r, preference.swigValue(), order.swigValue());
  }

  public void rotateX(double r, Transform.AnglePreference preference) {
    opensimModelJNI.Transform_rotateX(swigCPtr, this, r, preference.swigValue());
  }

  public void rotateY(double r, Transform.AnglePreference preference) {
    opensimModelJNI.Transform_rotateY(swigCPtr, this, r, preference.swigValue());
  }
  ...
  public void rotateXBodyFixed(double r, Transform.AnglePreference preference) {
    opensimModelJNI.Transform_rotateXBodyFixed(swigCPtr, this, r, preference.swigValue());
  }

  public void rotateYBodyFixed(double r, Transform.AnglePreference preference) {
    opensimModelJNI.Transform_rotateYBodyFixed(swigCPtr, this, r, preference.swigValue());
  }

  public void rotateZBodyFixed(double r, Transform.AnglePreference preference) {
    opensimModelJNI.Transform_rotateZBodyFixed(swigCPtr, this, r, preference.swigValue());
  }

  public void translateX(double t) {
    opensimModelJNI.Transform_translateX(swigCPtr, this, t);
  }

  public void translateY(double t) {
    opensimModelJNI.Transform_translateY(swigCPtr, this, t);
  }
  ...
  public SWIGTYPE_p_double getMatrix() {
    long cPtr = opensimModelJNI.Transform_getMatrix__SWIG_0(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public void getMatrix(double[] aMat) {
    opensimModelJNI.Transform_getMatrix__SWIG_1(swigCPtr, this, aMat);
  }

  public void setRotationSubmatrix(SWIGTYPE_p_a_3__double rDirCos) {
    opensimModelJNI.Transform_setRotationSubmatrix(swigCPtr, this, SWIGTYPE_p_a_3__double.getCPtr(rDirCos));
  }
