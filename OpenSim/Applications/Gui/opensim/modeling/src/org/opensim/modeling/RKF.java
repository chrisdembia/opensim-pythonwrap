...
public class RKF {
  ...
  public RKF(Integrand aIntegrand, double aTol, double aTolFine) {
    this(opensimModelJNI.new_RKF__SWIG_0(Integrand.getCPtr(aIntegrand), aIntegrand, aTol, aTolFine), true);
  }

  public RKF(Integrand aIntegrand, double aTol) {
    this(opensimModelJNI.new_RKF__SWIG_1(Integrand.getCPtr(aIntegrand), aIntegrand, aTol), true);
  }

  public RKF(Integrand aIntegrand) {
    this(opensimModelJNI.new_RKF__SWIG_2(Integrand.getCPtr(aIntegrand), aIntegrand), true);
  }

  public Integrand getIntegrand() {
    long cPtr = opensimModelJNI.RKF_getIntegrand(swigCPtr, this);
    return (cPtr == 0) ? null : new Integrand(cPtr, false);
  }

  public void setTolerance(double aTol, double aTolFine) {
    opensimModelJNI.RKF_setTolerance__SWIG_0(swigCPtr, this, aTol, aTolFine);
  }

  public void setTolerance(double aTol) {
    opensimModelJNI.RKF_setTolerance__SWIG_1(swigCPtr, this, aTol);
  }

  public double getTolerance() {
    return opensimModelJNI.RKF_getTolerance(swigCPtr, this);
  }

  public void setFineTolerance(double aFineTol) {
    opensimModelJNI.RKF_setFineTolerance(swigCPtr, this, aFineTol);
  }

  public double getFineTolerance() {
    return opensimModelJNI.RKF_getFineTolerance(swigCPtr, this);
  }

  public int step(double dt, double t, SWIGTYPE_p_double y) {
    return opensimModelJNI.RKF_step(swigCPtr, this, dt, t, SWIGTYPE_p_double.getCPtr(y));
  }

  public int stepFixed(double dt, double t, SWIGTYPE_p_double y) {
    return opensimModelJNI.RKF_stepFixed(swigCPtr, this, dt, t, SWIGTYPE_p_double.getCPtr(y));
  }
