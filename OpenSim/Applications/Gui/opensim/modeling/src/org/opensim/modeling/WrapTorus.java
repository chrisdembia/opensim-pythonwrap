...
public class WrapTorus extends AbstractWrapObject {
  ...
  public void scale(ArrayDouble aScaleFactors) {
    opensimModelJNI.WrapTorus_scale(swigCPtr, this, ArrayDouble.getCPtr(aScaleFactors), aScaleFactors);
  }
  ...
  public int wrapLine(ArrayDouble aPoint1, ArrayDouble aPoint2, MuscleWrap aMuscleWrap, SWIGTYPE_p_OpenSim__WrapResult aWrapResult, SWIGTYPE_p_bool aFlag) {
    return opensimModelJNI.WrapTorus_wrapLine(swigCPtr, this, ArrayDouble.getCPtr(aPoint1), aPoint1, ArrayDouble.getCPtr(aPoint2), aPoint2, MuscleWrap.getCPtr(aMuscleWrap), aMuscleWrap, SWIGTYPE_p_OpenSim__WrapResult.getCPtr(aWrapResult), SWIGTYPE_p_bool.getCPtr(aFlag));
  }

  public void peteTest() {
    opensimModelJNI.WrapTorus_peteTest(swigCPtr, this);
  }
