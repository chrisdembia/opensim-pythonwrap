...
public class VisibleProperties extends OpenSimObject {
  ...
  public VisibleProperties(long cPtr, boolean cMemoryOwn) {
    super(opensimModelJNI.SWIGStorageUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(VisibleProperties obj) {
  ...
  public VisibleProperties(VisibleProperties aVisibleProperties) {
    this(opensimModelJNI.new_VisibleProperties__SWIG_3(VisibleProperties.getCPtr(aVisibleProperties), aVisibleProperties), true);
  }

  public OpenSimObject copy() {
    long cPtr = opensimModelJNI.VisibleProperties_copy(swigCPtr, this);
    return (cPtr == 0) ? null : new OpenSimObject(cPtr, false);
  }

  public void setDisplayPreference(VisibleProperties.DisplayPreference aDisplayPreference) {
    opensimModelJNI.VisibleProperties_setDisplayPreference(swigCPtr, this, aDisplayPreference.swigValue());
  }

  public VisibleProperties.DisplayPreference getDisplayPreference() {
    return VisibleProperties.DisplayPreference.swigToEnum(opensimModelJNI.VisibleProperties_getDisplayPreference(swigCPtr, this));
  }

  public void setShowNormals(boolean showNormals) {
    opensimModelJNI.VisibleProperties_setShowNormals(swigCPtr, this, showNormals);
  }

  public boolean getShowNormals() {
    return opensimModelJNI.VisibleProperties_getShowNormals(swigCPtr, this);
  }

  public void setShowAxes(boolean showAxes) {
    opensimModelJNI.VisibleProperties_setShowAxes(swigCPtr, this, showAxes);
  }

  public boolean getShowAxes() {
    return opensimModelJNI.VisibleProperties_getShowAxes(swigCPtr, this);
  }

  public void setMaterialName(String matName) {
    opensimModelJNI.VisibleProperties_setMaterialName(swigCPtr, this, matName);
  }

  public String getMaterialName() {
    return opensimModelJNI.VisibleProperties_getMaterialName(swigCPtr, this);
  }

  public void getColor(double[] aColor) {
    opensimModelJNI.VisibleProperties_getColor(swigCPtr, this, aColor);
  }

  public void setColor(double[] aColor) {
    opensimModelJNI.VisibleProperties_setColor(swigCPtr, this, aColor);
  }
