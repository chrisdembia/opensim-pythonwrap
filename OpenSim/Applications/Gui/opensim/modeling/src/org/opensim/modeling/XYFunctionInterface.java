...
public class XYFunctionInterface extends OpenSimObject {
  ...
  public final static class FunctionType {
    ...
    public final static FunctionType typePiecewiseConstantFunction = new FunctionType("typePiecewiseConstantFunction");
    ...
    public final static FunctionType typeGCVSpline = new FunctionType("typeGCVSpline");
    public final static FunctionType typeUndefined = new FunctionType("typeUndefined");
