...
public class SetMuscleWrap extends OpenSimObject {
  ...
  public int getNumGroups() {
    return opensimModelJNI.SetMuscleWrap_getNumGroups(swigCPtr, this);
  }

  public void addGroup(String aGroupName) {
    opensimModelJNI.SetMuscleWrap_addGroup(swigCPtr, this, aGroupName);
  }

  public void removeGroup(String aGroupName) {
    opensimModelJNI.SetMuscleWrap_removeGroup(swigCPtr, this, aGroupName);
  }

  public void renameGroup(String oldGroupName, String newGroupName) {
    opensimModelJNI.SetMuscleWrap_renameGroup(swigCPtr, this, oldGroupName, newGroupName);
  }

  public void addObjectToGroup(String aGroupName, String aObjectName) {
    opensimModelJNI.SetMuscleWrap_addObjectToGroup(swigCPtr, this, aGroupName, aObjectName);
  }
  ...
  public ObjectGroup getGroup(String aGroupName) {
    long cPtr = opensimModelJNI.SetMuscleWrap_getGroup__SWIG_0(swigCPtr, this, aGroupName);
    return (cPtr == 0) ? null : new ObjectGroup(cPtr, false);
  }

  public ObjectGroup getGroup(int aIndex) {
    long cPtr = opensimModelJNI.SetMuscleWrap_getGroup__SWIG_1(swigCPtr, this, aIndex);
    return (cPtr == 0) ? null : new ObjectGroup(cPtr, false);
  }
