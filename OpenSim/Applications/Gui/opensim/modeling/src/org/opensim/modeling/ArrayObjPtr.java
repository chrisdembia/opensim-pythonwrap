...
public class ArrayObjPtr {
  ...
  public ArrayObjPtr(OpenSimObject aDefaultValue, int aSize, int aCapacity) {
    this(opensimModelJNI.new_ArrayObjPtr__SWIG_0(OpenSimObject.getCPtr(aDefaultValue), aSize, aCapacity), true);
  }

  public ArrayObjPtr(OpenSimObject aDefaultValue, int aSize) {
    this(opensimModelJNI.new_ArrayObjPtr__SWIG_1(OpenSimObject.getCPtr(aDefaultValue), aSize), true);
  }

  public ArrayObjPtr(OpenSimObject aDefaultValue) {
    this(opensimModelJNI.new_ArrayObjPtr__SWIG_2(OpenSimObject.getCPtr(aDefaultValue)), true);
  }
  ...
  public int append(OpenSimObject aValue) {
    return opensimModelJNI.ArrayObjPtr_append__SWIG_0(swigCPtr, this, OpenSimObject.getCPtr(aValue));
  }
  ...
  public int insert(int aIndex, OpenSimObject aValue) {
    return opensimModelJNI.ArrayObjPtr_insert(swigCPtr, this, aIndex, OpenSimObject.getCPtr(aValue));
  }
  ...
  public void set(int aIndex, OpenSimObject aValue) {
    opensimModelJNI.ArrayObjPtr_set(swigCPtr, this, aIndex, OpenSimObject.getCPtr(aValue));
  }
  ...
  public int findIndex(OpenSimObject aValue) {
    return opensimModelJNI.ArrayObjPtr_findIndex(swigCPtr, this, OpenSimObject.getCPtr(aValue));
  }

  public int rfindIndex(OpenSimObject aValue) {
    return opensimModelJNI.ArrayObjPtr_rfindIndex(swigCPtr, this, OpenSimObject.getCPtr(aValue));
  }

  public int searchBinary(OpenSimObject aValue, boolean aFindFirst, int aLo, int aHi) {
    return opensimModelJNI.ArrayObjPtr_searchBinary__SWIG_0(swigCPtr, this, OpenSimObject.getCPtr(aValue), aFindFirst, aLo, aHi);
  }

  public int searchBinary(OpenSimObject aValue, boolean aFindFirst, int aLo) {
    return opensimModelJNI.ArrayObjPtr_searchBinary__SWIG_1(swigCPtr, this, OpenSimObject.getCPtr(aValue), aFindFirst, aLo);
  }

  public int searchBinary(OpenSimObject aValue, boolean aFindFirst) {
    return opensimModelJNI.ArrayObjPtr_searchBinary__SWIG_2(swigCPtr, this, OpenSimObject.getCPtr(aValue), aFindFirst);
  }

  public int searchBinary(OpenSimObject aValue) {
    return opensimModelJNI.ArrayObjPtr_searchBinary__SWIG_3(swigCPtr, this, OpenSimObject.getCPtr(aValue));
  }
