...
public class NaturalCubicSpline extends Function {
  ...
  public double calcDerivative(SWIGTYPE_p_std__vectorTint_t derivComponents, SWIGTYPE_p_SimTK__Vector x) {
    return opensimModelJNI.NaturalCubicSpline_calcDerivative(swigCPtr, this, SWIGTYPE_p_std__vectorTint_t.getCPtr(derivComponents), SWIGTYPE_p_SimTK__Vector.getCPtr(x));
  }
