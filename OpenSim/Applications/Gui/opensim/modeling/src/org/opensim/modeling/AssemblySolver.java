...
public class AssemblySolver extends Solver {
  ...
  public void assemble(SWIGTYPE_p_SimTK__State s) {
    opensimModelJNI.AssemblySolver_assemble(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(s));
  }

  public void track(SWIGTYPE_p_SimTK__State s) {
    opensimModelJNI.AssemblySolver_track(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(s));
  }
