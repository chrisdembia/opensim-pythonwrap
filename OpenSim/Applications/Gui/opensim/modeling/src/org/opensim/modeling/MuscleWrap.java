...
public class MuscleWrap extends OpenSimObject {
  ...
  public MuscleWrap(MuscleWrap aMuscleWrap) {
    this(opensimModelJNI.new_MuscleWrap__SWIG_1(MuscleWrap.getCPtr(aMuscleWrap)), true);
  }

  public OpenSimObject copy() {
    long cPtr = opensimModelJNI.MuscleWrap_copy(swigCPtr);
    return (cPtr == 0) ? null : new OpenSimObject(cPtr, false);
  }

  public void copyData(MuscleWrap aMuscleWrap) {
    opensimModelJNI.MuscleWrap_copyData(swigCPtr, MuscleWrap.getCPtr(aMuscleWrap));
  }

  public void setup(AbstractDynamicsEngine aEngine) {
    opensimModelJNI.MuscleWrap_setup(swigCPtr, AbstractDynamicsEngine.getCPtr(aEngine));
  }

  public int getStartPoint() {
    return opensimModelJNI.MuscleWrap_getStartPoint(swigCPtr);
  }

  public int getEndPoint() {
    return opensimModelJNI.MuscleWrap_getEndPoint(swigCPtr);
  }

  public String getWrapObjectName() {
    return opensimModelJNI.MuscleWrap_getWrapObjectName(swigCPtr);
  }

  public AbstractWrapObject getWrapObject() {
    long cPtr = opensimModelJNI.MuscleWrap_getWrapObject(swigCPtr);
    return (cPtr == 0) ? null : new AbstractWrapObject(cPtr, false);
  }

  public SWIGTYPE_p_SimmMuscleWrapPoint getWrapPoint(int aIndex) {
    return new SWIGTYPE_p_SimmMuscleWrapPoint(opensimModelJNI.MuscleWrap_getWrapPoint(swigCPtr, aIndex), false);
  }

  public MuscleWrap.WrapMethod getMethod() {
    return MuscleWrap.WrapMethod.swigToEnum(opensimModelJNI.MuscleWrap_getMethod(swigCPtr));
  }

  public String getMethodName() {
    return opensimModelJNI.MuscleWrap_getMethodName(swigCPtr);
  }

  public SWIGTYPE_p_OpenSim__WrapResult getPreviousWrap() {
    return new SWIGTYPE_p_OpenSim__WrapResult(opensimModelJNI.MuscleWrap_getPreviousWrap(swigCPtr), false);
  }

  public void setPreviousWrap(SWIGTYPE_p_OpenSim__WrapResult aWrapResult) {
    opensimModelJNI.MuscleWrap_setPreviousWrap(swigCPtr, SWIGTYPE_p_OpenSim__WrapResult.getCPtr(aWrapResult));
  }

  public void resetPreviousWrap() {
    opensimModelJNI.MuscleWrap_resetPreviousWrap(swigCPtr);
  }

  public void peteTest() {
    opensimModelJNI.MuscleWrap_peteTest(swigCPtr);
  }
