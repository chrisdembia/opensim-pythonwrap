...
public class StorageInterface extends OpenSimObject {
  ...
  public int append(SWIGTYPE_p_OpenSim__ArrayTOpenSim__StateVector_t aArray) {
    return opensimModelJNI.StorageInterface_append__SWIG_2(swigCPtr, this, SWIGTYPE_p_OpenSim__ArrayTOpenSim__StateVector_t.getCPtr(aArray));
  }
  ...
  public int append(double aT, SWIGTYPE_p_SimTK__Vector aY, boolean aCheckForDuplicateTime) {
    return opensimModelJNI.StorageInterface_append__SWIG_5(swigCPtr, this, aT, SWIGTYPE_p_SimTK__Vector.getCPtr(aY), aCheckForDuplicateTime);
  }

  public int append(double aT, SWIGTYPE_p_SimTK__Vector aY) {
    return opensimModelJNI.StorageInterface_append__SWIG_6(swigCPtr, this, aT, SWIGTYPE_p_SimTK__Vector.getCPtr(aY));
  }

  public int append(double aT, SWIGTYPE_p_SimTK__Vec3 aY, boolean aCheckForDuplicateTime) {
    return opensimModelJNI.StorageInterface_append__SWIG_7(swigCPtr, this, aT, SWIGTYPE_p_SimTK__Vec3.getCPtr(aY), aCheckForDuplicateTime);
  }

  public int append(double aT, SWIGTYPE_p_SimTK__Vec3 aY) {
    return opensimModelJNI.StorageInterface_append__SWIG_8(swigCPtr, this, aT, SWIGTYPE_p_SimTK__Vec3.getCPtr(aY));
  }
