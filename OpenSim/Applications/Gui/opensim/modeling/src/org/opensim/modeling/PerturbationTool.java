...
public class PerturbationTool extends SimulationTool {
  ...
  public void run() {
    opensimModelJNI.PerturbationTool_run(swigCPtr);
  }

  public void printResults(String aBaseName, String aDir, double aDT, String aExtension) {
    opensimModelJNI.PerturbationTool_printResults__SWIG_0(swigCPtr, aBaseName, aDir, aDT, aExtension);
  }

  public void printResults(String aBaseName, String aDir, double aDT) {
    opensimModelJNI.PerturbationTool_printResults__SWIG_1(swigCPtr, aBaseName, aDir, aDT);
  }

  public void printResults(String aBaseName, String aDir) {
    opensimModelJNI.PerturbationTool_printResults__SWIG_2(swigCPtr, aBaseName, aDir);
  }

  public void printResults(String aBaseName) {
    opensimModelJNI.PerturbationTool_printResults__SWIG_3(swigCPtr, aBaseName);
  }
