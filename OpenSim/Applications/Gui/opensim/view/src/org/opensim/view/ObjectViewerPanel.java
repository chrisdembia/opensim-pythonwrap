...
/*
 * ObjectViewerPanel.java
 *
 * Modified version of code provided by Sun Micro.
 *
 */
...
public class ObjectViewerPanel extends JPanel {
    ...
    public ObjectViewerPanel(OpenSimObject aObject, boolean allowModification, String mdlName) {
	this.object = aObject;
	editMode = allowModification;

	model = createModel(aObject, editMode, mdlName);
     ...
     */
    protected OpenSimObjectModel createModel(OpenSimObject object, boolean editable, String mdlName) {
	return new OpenSimObjectModel(object, editable, mdlName);
    }
