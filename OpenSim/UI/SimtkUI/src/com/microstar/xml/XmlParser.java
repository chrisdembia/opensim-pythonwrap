...
// $Id: XmlParser.java,v 1.11 2003/05/17 05:19:48 cxh Exp $
...

    ...
    throws java.lang.Exception
  {
    ...
    if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
      enumString = dataBufferToString();
    }

				// Read the default value.
    requireWhitespace();
    parseDefault(elementName, name, type, enumString);
  }
  ...
  /**
    ...
    */
  void parseDefault (String elementName, String name, int type, String enumString)
    throws java.lang.Exception
  {
    ...
    setAttribute(elementName, name, type, enumString, value, valueType);
  }
