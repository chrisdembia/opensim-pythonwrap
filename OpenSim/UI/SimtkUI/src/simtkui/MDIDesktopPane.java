 ...
 * left or bottom, providing the MDIDesktopPane is in a ScrollPane. Originally
 * from Javaworld article by Gerald Nunn, May 2001
 *
 * @todo if window overlap bug due to mixing lightweight and heavyweight
 * components becomes an issue we can put a stop-gap here to block overlapping
 * model windows.
 */
public class MDIDesktopPane extends JDesktopPane {
     ...
     * Entry point for this functionality is not enabled due to Swing bug drawing heavyweight components
     */
 ...
 //A       if (getParent()!=null&&isVisible()) manager.resizeDesktop();
    }
}
