...
public class SimtkrdObjectModel
  ...
  /**
   * Creates a SimtkrdObjectModel with the root being <code>rootPath</code>.
  ...
  class PropertyNode {
    ...
    protected void setChildren(PropertyNode[] newChildren,
      ...
      if (generateEvent) {
        ...
        fireTreeStructureChanged(SimtkrdObjectModel.this, path, null,
                                 null);
    ...
    protected void nodeChanged() {
      ...
      if (parent != null) {
        ...
        fireTreeNodesChanged(SimtkrdObjectModel.this, path, index,
                             children);
      }
    }
      ...
      if (isValid) {
        SwingUtilities.invokeLater(new Runnable() {
          public void run() {
            ...
            synchronized (SimtkrdObjectModel.this) {
              reloadCount--;
              SimtkrdObjectModel.this.notifyAll();
            }
          }
        });
      }
