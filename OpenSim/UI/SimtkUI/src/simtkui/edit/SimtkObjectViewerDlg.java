 ...
 * @author Philip Milne
 */
public class SimtkObjectViewerDlg extends SimtkJDialog {
    /** Number of instances of SimtkObjectViewerDlg. */
    protected static int         ttCount;

    /** Model for the JTreeTable. */
    protected SimtkrdObjectModel    model;
