...
c SPRING PARAMETERS
      data y0,b0,b1,c0,c1 /6.5905d-3,0.5336322,0.0d0,0.0d0,-1150.8002d0/    
      data s0,s1,s2 /0.02d0,10.0d0,500.0d0/
      data sk,mu,sdamp /6.9d6,0.7d0,1.0d3/
      data bodyspt / -0.071650,-0.038653,-0.050428,
...
c                        lhindfoot, ltoe. 
      ...
      data rfo/  0.0707, 0.0028, 0.0100 ,  0.0000,-0.3202, 0.0000 ,
     &           0.0020, 0.1715, 0.0000 ,  0.0000, 0.1862, 0.0000 ,  
     &          -0.0839, 0.0094,-0.0013 , -0.0262, 0.0065,-0.0079 ,  
     &           0.0020, 0.1715, 0.0000 ,  0.0000, 0.1862, 0.0000 ,  
     &          -0.0839, 0.0094, 0.0013 , -0.0262, 0.0065, 0.0079 /  
