...
#include <RD/Simulation/SDFast/SDFast.h>
#include <RD/Simulation/SDFast/ActuatedModel_SDFast.h>
 ...
 */
suSIMMPipeline323::suSIMMPipeline323(char *aParametersFileName,ContactForceSet *aContacts) :
	ActuatedModel_SDFast(NULL,aContacts)
{
   setNull();
...
setConfiguration(const double aY[])
{
	...
	SDFast::setConfiguration(aY);
}


//=============================================================================
// CONTACT : see ActuatedModel_SDFast.cpp
//=============================================================================
...
//=============================================================================
// DERIVATIVES : see ActuatedModel_SDFast.cpp
//=============================================================================
//_____________________________________________________________________________
/**
...
//=============================================================================
// CALLBACK : see ActuatedModel_SDFast.cpp
//=============================================================================
//_____________________________________________________________________________
/**
