 ...
 * the class implements the "actuation" and "deriv" methods of Model.
 * In the deriv() methods the appropriate calls are made for any
 * DerivCallback's registered on the model.  Also, the appropriate calls
 ...
 * @version 1.0
 */
class RDSDFAST_API suSIMMPipeline323 : public ActuatedModel_SDFast
{
//=============================================================================
// DATA
//=============================================================================
...
//=============================================================================
public:
	suSIMMPipeline323(char *aParametersFileName,ContactForceSet *aContacts=NULL);
