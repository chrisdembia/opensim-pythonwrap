 ...
 * Destructor.
 */
suActuatorPerturbation::~suActuatorPerturbation()
{
}
//_____________________________________________________________________________
/**
	...
	rdDerivCallback(aModel)
{
	...
	setType("suActuatorPerturbation");
}
 ...
 */
suActuatorPerturbation::PertType suActuatorPerturbation::
...
//_____________________________________________________________________________
/**
 * Get a pointer to the rdStorage containing the nominal and perturbed forces.
 *
 * @return Pointer to the force storage. 
 */
rdStorage* suActuatorPerturbation::
getForceStorage()
{
	return(_forceStore);
}
...
computeActuation(double aT,double *aX,double *aY)
{
	...
	//	printf("perturbing\n");
		...
		// UNRECOGNIZED
			...
			printf("suActuatorPerturbation.computeActuation:- unrecognized perturbationType.\n");
			force = _force;
		}
