 ...
 * Destructor.
 */
suActuatorGeneralizedForces::~suActuatorGeneralizedForces()
{
...
//_____________________________________________________________________________
/**
 * Construct an suGeneralizedForces object for recording the joint torques due
 ...
 */
rdStorage* suActuatorGeneralizedForces::
 ...
 */
int suActuatorGeneralizedForces::
...
{
	if(!proceed()) return(0);
	cout<<"suActuatorGeneralizedForces.end: Finalizing analysis "<<
		getName()<<".\n";
	return(0);
}
