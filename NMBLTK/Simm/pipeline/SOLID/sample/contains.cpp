...
Point vertices[3];
vertices[0][0] = -0.485071;
vertices[0][1] = 0.0;
vertices[0][2] = 0.121268;
vertices[1][0] = -0.485071;
vertices[1][1] = 0.121268;
vertices[1][2] = 0.0;
vertices[2][0] = -0.5;
vertices[2][1] = 0.0;
vertices[2][2] = 0.0;
VertexBase vb(vertices);
Polygon polyA(vb, 3, indices);
...
vertices[1][1] = -0.121268;
vertices[1][2] = 0.0;
vertices[2][0] = 0.485071;
vertices[2][1] = 0.0;
vertices[2][2] = -0.121268;
VertexBase vb2(vertices);
Polygon polyB(vb2, 3, indices);
