...
{
	// TYPE
	setType("rdActuatorSet");
	// NAME
	setName("rdActuatorSet");
...
constructControlMaps()
{
	...
	// DEBUG
	//cout<<"\n\nrdActuatorSet: ActuatorToControl Map:"<<endl;
	...
	// DEBUG
	//cout<<"\nrdActuatorSet: ControlToActuator Map:"<<endl;
...
constructStateMaps()
{
	...
	// DEBUG
	//cout<<"\n\nrdActuatorSet: ActuatorToState Map:"<<endl;
	...
	// DEBUG
	//cout<<"\nrdActuatorSet: StateToActuator Map:"<<endl;
...
constructPseudoStateMaps()
{
	...
	// DEBUG
	//cout<<"\n\nrdActuatorSet: ActuatorToPseudo Map:"<<endl;
	...
	// DEBUG
	//cout<<"\nrdActuatorSet: PseudoToActuator Map:"<<endl;
 ...
 */
rdActuatorSet& rdActuatorSet::
operator=(const rdActuatorSet &aActuatorSet)
{
	// BASE CLASS
	rdSet<rdActuator>::operator=(aActuatorSet);
...
remove(int aIndex)
{
	bool success = rdSet<rdActuator>::remove(aIndex);
 ...
 * is not made.
 *
 * This method overrides the method in rdSet<rdActuator> so that several
 ...
 */
bool rdActuatorSet::
append(rdActuator *aActuator)
{
	bool success = rdSet<rdActuator>::append(aActuator);
 ...
 */
bool rdActuatorSet::
set(int aIndex,rdActuator *aActuator)
{
	bool success = rdSet<rdActuator>::set(aIndex,aActuator);
 ...
 * of values.  The convention used by rdActuatorSet is that the controls for an
 ...
 * the model in an array of values.  The convention used by rdActuatorSet is that
