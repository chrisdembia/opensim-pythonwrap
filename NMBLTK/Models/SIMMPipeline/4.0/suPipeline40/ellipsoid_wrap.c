...
static void dell(double r1[], double r2[], double m[], double a[], double vs[], 
	         double vs4, dpBoolean far_side_wrap, double *afst, double** wrap_pts, int* num_wrap_pts);
	...
	dpWrapObject*	wo)
{
   ...
   *wrap_pts     = NULL;
    ...
    */
   {
      dpBoolean use_c1_to_find_tangent_pts = dpYes;
   
      if (mwrap->wrap_algorithm == WE_AXIAL_ALGORITHM)
         use_c1_to_find_tangent_pts = (dpBoolean) (t[bestMu] > 0.0 && t[bestMu] < 1.0);
...
static double pt_to_ellipse (double a, double b, double u, double v, double* x, double* y)
{
    ...
    dpBoolean nearXOrigin = (dpBoolean) EQUAL_WITHIN_ERROR(0.0,u);
    dpBoolean nearYOrigin = (dpBoolean) EQUAL_WITHIN_ERROR(0.0,v);
...
static void dell (double r1[], double r2[], double m[], double a[], 
	          double vs[], double vs4, dpBoolean far_side_wrap,
	          double *afst,
	          double** wrap_pts, int* num_wrap_pts)
{
   int i, j, k, l, imax, index;
