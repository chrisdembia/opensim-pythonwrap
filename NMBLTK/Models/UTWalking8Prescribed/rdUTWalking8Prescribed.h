...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#ifndef __rdUTWalking8Prescribed_h__
#define __rdUTWalking8Prescribed_h__
...
const int rdUTWalking8Prescribed_IMSF = rdUTWalking8Prescribed_NQ + rdUTWalking8Prescribed_NU;
 ...
 */
class RDSDFAST_API rdUTWalking8Prescribed : public rdActuatedModel_SDFast
{
//=============================================================================
// DATA
//=============================================================================
public:
	...
	double _tcFall;
	double _jdamp;
	int _sBodies[rdUTWalking8Prescribed_NS];
	double _sPoints[rdUTWalking8Prescribed_NS][3];
...
protected:
	...
	double *_actsv;
	/** Spring positions. */
	double _spos[rdUTWalking8Prescribed_NS][3];
	/** Spring velocities. */
	double _svel[rdUTWalking8Prescribed_NS][3];
	/** Spring forces. */
	double _sfrc[rdUTWalking8Prescribed_NS][3];
	bool _store;
...
public:
	...
	rdUTWalking8Prescribed(const rdActuatorSet *aActuatorSet=NULL,
...
#endif // #ifndef __rdUTWalking8Prescribed_h__
