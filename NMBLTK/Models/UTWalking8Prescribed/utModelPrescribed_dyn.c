/*
Generated 27-Dec-2005 16:51:38 by SD/FAST, Kane's formulation
...
--- --------- ---- ----------- ---------------- -----------------------
 -1 $ground                                    |
  ...
  3 rtibia      2  Gimbal       12? 13? 14?    |  6p  7p  8p
  4 rhindfoot   3  Gimbal       15? 16? 17?    |  9p 10p 11p
  5 rtoes       4  Gimbal       18? 19? 20?    | 12p 13p 14p
  6 lfemur      0  Gimbal       21? 22? 23?    | 15p 16p 17p
  7 ltibia      6  Gimbal       24? 25? 26?    | 18p 19p 20p
  8 lhindfoot   7  Gimbal       27? 28? 29?    | 21p 22p 23p
  9 ltoes       8  Gimbal       30? 31? 32?    | 24p 25p 26p
...
typedef struct {
    ...
    double perr_[27],verr_[27],aerr_[27],mult_[27],ufk_[10][3],utk_[10][3],mfk_[
      10][3],mtk_[10][3];
...
typedef struct {
    ...
    double w00w11_[10],w00w22_[10],w11w22_[10],ww_[27][27],qraux_[27];
...
*/
    ...
    rnk[20][2] = (rnk[18][2]+((.005139*cnk[20][2][2])+((.0185*cnk[20][2][1])+(
      .026917*cnk[20][2][0]))));
    rnk[21][0] = (q[0]-((.07*Cik[3][0][1])+(.0935*Cik[3][0][2])));
    rnk[21][1] = (q[1]-((.07*Cik[3][1][1])+(.0935*Cik[3][1][2])));
    rnk[21][2] = (q[2]-((.07*Cik[3][2][1])+(.0935*Cik[3][2][2])));
...
*/
    ...
    vnk[21][0] = (u[0]+(((.0935*(Cik[3][0][1]*u[3]))+(Cik[3][0][0]*Wirk[21][0]))
      -(.07*(Cik[3][0][2]*u[3]))));
    vnk[21][1] = (u[1]+(((.0935*(Cik[3][1][1]*u[3]))+(Cik[3][1][0]*Wirk[21][0]))
      -(.07*(Cik[3][1][2]*u[3]))));
    vnk[21][2] = (u[2]+(((.0935*(Cik[3][2][1]*u[3]))+(Cik[3][2][0]*Wirk[21][0]))
      -(.07*(Cik[3][2][2]*u[3]))));
...
/*
 ...
 Equations contain 2609 adds/subtracts/negates
                   3958 multiplies
                      1 divides
                   1556 assignments
*/
...
*/
        ...
        Vpk[0][5][1] = Cik[3][0][1];
        Vpk[0][5][2] = Cik[3][0][2];
        Vpk[0][6][0] = ((Cik[3][0][2]*Cik[6][2][0])+((Cik[3][0][0]*Cik[6][0][0])
          +(Cik[3][0][1]*Cik[6][1][0])));
        Vpk[0][6][1] = ((Cik[3][0][2]*Cik[6][2][1])+((Cik[3][0][0]*Cik[6][0][1])
          +(Cik[3][0][1]*Cik[6][1][1])));
        Vpk[0][6][2] = ((Cik[3][0][2]*Cik[6][2][2])+((Cik[3][0][0]*Cik[6][0][2])
          +(Cik[3][0][1]*Cik[6][1][2])));
        ...
        Vpk[0][8][2] = ((Cik[8][2][2]*Vpk[0][7][2])+((Cik[8][0][2]*Vpk[0][7][0])
          +(Cik[8][1][2]*Vpk[0][7][1])));
        Vpk[0][9][0] = ((Cik[3][0][2]*Cik[9][2][0])+((Cik[3][0][0]*Cik[9][0][0])
          +(Cik[3][0][1]*Cik[9][1][0])));
        Vpk[0][9][1] = ((Cik[3][0][2]*Cik[9][2][1])+((Cik[3][0][0]*Cik[9][0][1])
          +(Cik[3][0][1]*Cik[9][1][1])));
        Vpk[0][9][2] = ((Cik[3][0][2]*Cik[9][2][2])+((Cik[3][0][0]*Cik[9][0][2])
          +(Cik[3][0][1]*Cik[9][1][2])));
        ...
        Vpk[0][21][0] = ((Cik[3][0][2]*Cik[21][2][0])+((Cik[3][0][0]*
          Cik[21][0][0])+(Cik[3][0][1]*Cik[21][1][0])));
        Vpk[0][21][1] = ((Cik[3][0][2]*Cik[21][2][1])+((Cik[3][0][0]*
          Cik[21][0][1])+(Cik[3][0][1]*Cik[21][1][1])));
        Vpk[0][21][2] = ((Cik[3][0][2]*Cik[21][2][2])+((Cik[3][0][0]*
          Cik[21][0][2])+(Cik[3][0][1]*Cik[21][1][2])));
        ...
        Vpk[1][5][1] = Cik[3][1][1];
        Vpk[1][5][2] = Cik[3][1][2];
        Vpk[1][6][0] = ((Cik[3][1][2]*Cik[6][2][0])+((Cik[3][1][0]*Cik[6][0][0])
          +(Cik[3][1][1]*Cik[6][1][0])));
        Vpk[1][6][1] = ((Cik[3][1][2]*Cik[6][2][1])+((Cik[3][1][0]*Cik[6][0][1])
          +(Cik[3][1][1]*Cik[6][1][1])));
        Vpk[1][6][2] = ((Cik[3][1][2]*Cik[6][2][2])+((Cik[3][1][0]*Cik[6][0][2])
          +(Cik[3][1][1]*Cik[6][1][2])));
        ...
        Vpk[1][8][2] = ((Cik[8][2][2]*Vpk[1][7][2])+((Cik[8][0][2]*Vpk[1][7][0])
          +(Cik[8][1][2]*Vpk[1][7][1])));
        Vpk[1][9][0] = ((Cik[3][1][2]*Cik[9][2][0])+((Cik[3][1][0]*Cik[9][0][0])
          +(Cik[3][1][1]*Cik[9][1][0])));
        Vpk[1][9][1] = ((Cik[3][1][2]*Cik[9][2][1])+((Cik[3][1][0]*Cik[9][0][1])
          +(Cik[3][1][1]*Cik[9][1][1])));
        Vpk[1][9][2] = ((Cik[3][1][2]*Cik[9][2][2])+((Cik[3][1][0]*Cik[9][0][2])
          +(Cik[3][1][1]*Cik[9][1][2])));
        ...
        Vpk[1][21][0] = ((Cik[3][1][2]*Cik[21][2][0])+((Cik[3][1][0]*
          Cik[21][0][0])+(Cik[3][1][1]*Cik[21][1][0])));
        Vpk[1][21][1] = ((Cik[3][1][2]*Cik[21][2][1])+((Cik[3][1][0]*
          Cik[21][0][1])+(Cik[3][1][1]*Cik[21][1][1])));
        Vpk[1][21][2] = ((Cik[3][1][2]*Cik[21][2][2])+((Cik[3][1][0]*
          Cik[21][0][2])+(Cik[3][1][1]*Cik[21][1][2])));
        ...
        Vpk[2][5][1] = Cik[3][2][1];
        Vpk[2][5][2] = Cik[3][2][2];
        Vpk[2][6][0] = ((Cik[3][2][2]*Cik[6][2][0])+((Cik[3][2][0]*Cik[6][0][0])
          +(Cik[3][2][1]*Cik[6][1][0])));
        Vpk[2][6][1] = ((Cik[3][2][2]*Cik[6][2][1])+((Cik[3][2][0]*Cik[6][0][1])
          +(Cik[3][2][1]*Cik[6][1][1])));
        Vpk[2][6][2] = ((Cik[3][2][2]*Cik[6][2][2])+((Cik[3][2][0]*Cik[6][0][2])
          +(Cik[3][2][1]*Cik[6][1][2])));
        ...
        Vpk[2][8][2] = ((Cik[8][2][2]*Vpk[2][7][2])+((Cik[8][0][2]*Vpk[2][7][0])
          +(Cik[8][1][2]*Vpk[2][7][1])));
        Vpk[2][9][0] = ((Cik[3][2][2]*Cik[9][2][0])+((Cik[3][2][0]*Cik[9][0][0])
          +(Cik[3][2][1]*Cik[9][1][0])));
        Vpk[2][9][1] = ((Cik[3][2][2]*Cik[9][2][1])+((Cik[3][2][0]*Cik[9][0][1])
          +(Cik[3][2][1]*Cik[9][1][1])));
        Vpk[2][9][2] = ((Cik[3][2][2]*Cik[9][2][2])+((Cik[3][2][0]*Cik[9][0][2])
          +(Cik[3][2][1]*Cik[9][1][2])));
        ...
        Vpk[2][21][0] = ((Cik[3][2][2]*Cik[21][2][0])+((Cik[3][2][0]*
          Cik[21][0][0])+(Cik[3][2][1]*Cik[21][1][0])));
        Vpk[2][21][1] = ((Cik[3][2][2]*Cik[21][2][1])+((Cik[3][2][0]*
          Cik[21][0][1])+(Cik[3][2][1]*Cik[21][1][1])));
        Vpk[2][21][2] = ((Cik[3][2][2]*Cik[21][2][2])+((Cik[3][2][0]*
          Cik[21][0][2])+(Cik[3][2][1]*Cik[21][1][2])));
...
/*
 ...
 0 additional bytes of memory.
 Equations contain 3374 adds/subtracts/negates
                   4902 multiplies
                      0 divides
                   1763 assignments
*/
...
*/
        ...
        temp[0] = ((8.806*((Vpk[0][11][2]*Vpk[0][11][2])+((Vpk[0][11][0]*
          Vpk[0][11][0])+(Vpk[0][11][1]*Vpk[0][11][1]))))+((11.15*((Cik[3][0][2]
        ...
        temp[0] = ((8.806*((Vpk[0][11][2]*Vpk[1][11][2])+((Vpk[0][11][0]*
          Vpk[1][11][0])+(Vpk[0][11][1]*Vpk[1][11][1]))))+((11.15*((Cik[3][0][2]
        ...
        temp[0] = ((8.806*((Vpk[0][11][2]*Vpk[2][11][2])+((Vpk[0][11][0]*
          Vpk[2][11][0])+(Vpk[0][11][1]*Vpk[2][11][1]))))+((11.15*((Cik[3][0][2]
        ...
        temp[0] = ((8.806*((Vpk[1][11][2]*Vpk[1][11][2])+((Vpk[1][11][0]*
          Vpk[1][11][0])+(Vpk[1][11][1]*Vpk[1][11][1]))))+((11.15*((Cik[3][1][2]
        ...
        temp[0] = ((8.806*((Vpk[1][11][2]*Vpk[2][11][2])+((Vpk[1][11][0]*
          Vpk[2][11][0])+(Vpk[1][11][1]*Vpk[2][11][1]))))+((11.15*((Cik[3][1][2]
        ...
        temp[0] = ((8.806*((Vpk[2][11][2]*Vpk[2][11][2])+((Vpk[2][11][0]*
          Vpk[2][11][0])+(Vpk[2][11][1]*Vpk[2][11][1]))))+((11.15*((Cik[3][2][2]
...
*/
    ...
    temp[0] = (((fstareq[14][2]*Vpk[0][14][2])+((fstareq[14][0]*Vpk[0][14][0])+(
      ...
      Vpk[0][8][0])+(fstareq[8][1]*Vpk[0][8][1]))))));
    ...
    temp[0] = (((fstareq[14][2]*Vpk[1][14][2])+((fstareq[14][0]*Vpk[1][14][0])+(
      ...
      Vpk[1][8][0])+(fstareq[8][1]*Vpk[1][8][1]))))));
    ...
    temp[0] = (((fstareq[14][2]*Vpk[2][14][2])+((fstareq[14][0]*Vpk[2][14][0])+(
      ...
      Vpk[2][8][0])+(fstareq[8][1]*Vpk[2][8][1]))))));
...
*/
    ...
    temp[0] = (((mfk[3][2]*Vpk[0][14][2])+((mfk[3][0]*Vpk[0][14][0])+(mfk[3][1]*
      ...
      mfk[2][1]*Vpk[0][11][1])))+(((Cik[3][0][2]*mfk[0][2])+((Cik[3][0][0]*
    ...
    temp[0] = (((mfk[3][2]*Vpk[1][14][2])+((mfk[3][0]*Vpk[1][14][0])+(mfk[3][1]*
      ...
      mfk[2][1]*Vpk[1][11][1])))+(((Cik[3][1][2]*mfk[0][2])+((Cik[3][1][0]*
    ...
    temp[0] = (((mfk[3][2]*Vpk[2][14][2])+((mfk[3][0]*Vpk[2][14][0])+(mfk[3][1]*
      ...
      mfk[2][1]*Vpk[2][11][1])))+(((Cik[3][2][2]*mfk[0][2])+((Cik[3][2][0]*
...
*/
    ...
    trqout[0] = -(utau[0]+(((fstarr[32][2]*Vpk[0][32][2])+((fstarr[32][0]*
      Vpk[0][32][0])+(fstarr[32][1]*Vpk[0][32][1])))+(((fstarr[29][2]*
      Vpk[0][29][2])+((fstarr[29][0]*Vpk[0][29][0])+(fstarr[29][1]*Vpk[0][29][1]
      )))+temp[1])));
    ...
    trqout[1] = -(utau[1]+(((fstarr[32][2]*Vpk[1][32][2])+((fstarr[32][0]*
      Vpk[1][32][0])+(fstarr[32][1]*Vpk[1][32][1])))+(((fstarr[29][2]*
      Vpk[1][29][2])+((fstarr[29][0]*Vpk[1][29][0])+(fstarr[29][1]*Vpk[1][29][1]
      )))+temp[1])));
    ...
    trqout[2] = -(utau[2]+(((fstarr[32][2]*Vpk[2][32][2])+((fstarr[32][0]*
      Vpk[2][32][0])+(fstarr[32][1]*Vpk[2][32][1])))+(((fstarr[29][2]*
      Vpk[2][29][2])+((fstarr[29][0]*Vpk[2][29][0])+(fstarr[29][1]*Vpk[2][29][1]
      )))+temp[1])));
    ...
    trqout[3] = -(utau[3]+((((fstarr[32][2]*Vpk[3][32][2])+((fstarr[32][0]*
      Vpk[3][32][0])+(fstarr[32][1]*Vpk[3][32][1])))+((tstarr[32][2]*
      Wpk[3][32][2])+((tstarr[32][0]*Wpk[3][32][0])+(tstarr[32][1]*Wpk[3][32][1]
      ))))+temp[3]));
    ...
    trqout[4] = -(utau[4]+((((fstarr[32][2]*Vpk[4][32][2])+((fstarr[32][0]*
      Vpk[4][32][0])+(fstarr[32][1]*Vpk[4][32][1])))+((tstarr[32][2]*
      Wpk[4][32][2])+((tstarr[32][0]*Wpk[4][32][0])+(tstarr[32][1]*Wpk[4][32][1]
      ))))+temp[3]));
    ...
    trqout[5] = -(utau[5]+((((fstarr[32][2]*Vpk[5][32][2])+((fstarr[32][0]*
      Vpk[5][32][0])+(fstarr[32][1]*Vpk[5][32][1])))+((tstarr[32][2]*
      Wpk[5][32][2])+((tstarr[32][0]*Wpk[5][32][0])+(tstarr[32][1]*Wpk[5][32][1]
      ))))+temp[3]));
...
/*
 ...
 0 additional bytes of memory.
 Equations contain 1544 adds/subtracts/negates
                   1638 multiplies
                      0 divides
                    315 assignments
*/
...
void sdmulttrq(double multin[27],
    double trqout[33])
{
...
*/
    ...
    if (pres[23]  !=  0.) {
        perr[17] = (q[23]-upos[23]);
    } else {
        perr[17] = 0.;
    }
    if (pres[24]  !=  0.) {
        perr[18] = (q[24]-upos[24]);
    } else {
        perr[18] = 0.;
    }
    if (pres[25]  !=  0.) {
        perr[19] = (q[25]-upos[25]);
    } else {
        perr[19] = 0.;
    }
    if (pres[26]  !=  0.) {
        perr[20] = (q[26]-upos[26]);
    } else {
        perr[20] = 0.;
    }
    if (pres[27]  !=  0.) {
        perr[21] = (q[27]-upos[27]);
    } else {
        perr[21] = 0.;
    }
    if (pres[28]  !=  0.) {
        perr[22] = (q[28]-upos[28]);
    } else {
        perr[22] = 0.;
    }
    if (pres[29]  !=  0.) {
        perr[23] = (q[29]-upos[29]);
    } else {
        perr[23] = 0.;
    }
    if (pres[30]  !=  0.) {
        perr[24] = (q[30]-upos[30]);
    } else {
        perr[24] = 0.;
    }
    if (pres[31]  !=  0.) {
        perr[25] = (q[31]-upos[31]);
    } else {
        perr[25] = 0.;
    }
    if (pres[32]  !=  0.) {
        perr[26] = (q[32]-upos[32]);
    } else {
        perr[26] = 0.;
    }
    errs[0] = perr[0];
...
*/
    ...
    if (pres[23]  !=  0.) {
        verr[17] = (u[23]-uvel[23]);
    } else {
        verr[17] = 0.;
    }
    if (pres[24]  !=  0.) {
        verr[18] = (u[24]-uvel[24]);
    } else {
        verr[18] = 0.;
    }
    if (pres[25]  !=  0.) {
        verr[19] = (u[25]-uvel[25]);
    } else {
        verr[19] = 0.;
    }
    if (pres[26]  !=  0.) {
        verr[20] = (u[26]-uvel[26]);
    } else {
        verr[20] = 0.;
    }
    if (pres[27]  !=  0.) {
        verr[21] = (u[27]-uvel[27]);
    } else {
        verr[21] = 0.;
    }
    if (pres[28]  !=  0.) {
        verr[22] = (u[28]-uvel[28]);
    } else {
        verr[22] = 0.;
    }
    if (pres[29]  !=  0.) {
        verr[23] = (u[29]-uvel[29]);
    } else {
        verr[23] = 0.;
    }
    if (pres[30]  !=  0.) {
        verr[24] = (u[30]-uvel[30]);
    } else {
        verr[24] = 0.;
    }
    if (pres[31]  !=  0.) {
        verr[25] = (u[31]-uvel[31]);
    } else {
        verr[25] = 0.;
    }
    if (pres[32]  !=  0.) {
        verr[26] = (u[32]-uvel[32]);
    } else {
        verr[26] = 0.;
    }
    errs[0] = verr[0];
...
*/
    ...
    if (pres[23]  !=  0.) {
        aerr[17] = (udot[23]-uacc[23]);
    } else {
        aerr[17] = 0.;
    }
    if (pres[24]  !=  0.) {
        aerr[18] = (udot[24]-uacc[24]);
    } else {
        aerr[18] = 0.;
    }
    if (pres[25]  !=  0.) {
        aerr[19] = (udot[25]-uacc[25]);
    } else {
        aerr[19] = 0.;
    }
    if (pres[26]  !=  0.) {
        aerr[20] = (udot[26]-uacc[26]);
    } else {
        aerr[20] = 0.;
    }
    if (pres[27]  !=  0.) {
        aerr[21] = (udot[27]-uacc[27]);
    } else {
        aerr[21] = 0.;
    }
    if (pres[28]  !=  0.) {
        aerr[22] = (udot[28]-uacc[28]);
    } else {
        aerr[22] = 0.;
    }
    if (pres[29]  !=  0.) {
        aerr[23] = (udot[29]-uacc[29]);
    } else {
        aerr[23] = 0.;
    }
    if (pres[30]  !=  0.) {
        aerr[24] = (udot[30]-uacc[30]);
    } else {
        aerr[24] = 0.;
    }
    if (pres[31]  !=  0.) {
        aerr[25] = (udot[31]-uacc[31]);
    } else {
        aerr[25] = 0.;
    }
    if (pres[32]  !=  0.) {
        aerr[26] = (udot[32]-uacc[32]);
    } else {
        aerr[26] = 0.;
    }
    errs[0] = aerr[0];
...
/*
 ...
 0 additional bytes of memory.
 Equations contain 12474 adds/subtracts/negates
                   12474 multiplies
                      0 divides
                   16335 assignments
*/
...
system with 33 degree(s) of freedom, including 6 degrees
of freedom for attitude and translation of the base body.
27 of the degrees of freedom may follow prescribed motion.
...
/*
 Used 0.00 seconds CPU time,
 0 additional bytes of memory.
 Equations contain  114 adds/subtracts/negates
                     54 multiplies
                      0 divides
                    181 assignments
*/
...
/*
 Used 0.02 seconds CPU time,
 0 additional bytes of memory.
 Equations contain  862 adds/subtracts/negates
                    640 multiplies
                      0 divides
                    546 assignments
*/
...
*/
    ...
    temp[0] = (((11.15*((q[1]*u[2])-(q[2]*u[1])))+((.0548*(Cik[3][0][2]*u[5]))+(
      ...
      wk[8][2]))+((.7153*(cnk[8][0][1]*wk[8][1]))+(1.396*(cnk[8][0][0]*wk[8][0])
      )))));
    ...
    temp[0] = (((11.15*((q[2]*u[0])-(q[0]*u[2])))+((.0548*(Cik[3][1][2]*u[5]))+(
      ...
      wk[8][2]))+((.7153*(cnk[8][1][1]*wk[8][1]))+(1.396*(cnk[8][1][0]*wk[8][0])
      )))));
    ...
    temp[0] = (((11.15*((q[0]*u[1])-(q[1]*u[0])))+((.0548*(Cik[3][2][2]*u[5]))+(
      ...
      wk[8][2]))+((.7153*(cnk[8][2][1]*wk[8][1]))+(1.396*(cnk[8][2][0]*wk[8][0])
      )))));
...
*/
    ...
    *mtoto = 71.005252;
    ...
    temp[0] = (((11.15*((q[1]*q[1])+(q[2]*q[2])))+((.0548*(Cik[3][0][2]*
      ...
      ((1.3552*(cnk[8][0][2]*cnk[8][0][2]))+((.7153*(cnk[8][0][1]*cnk[8][0][1]))
    ...
    temp[0] = ((((.0548*(Cik[3][0][2]*Cik[3][1][2]))+((.0825*(Cik[3][0][1]*
      ...
      (((1.3552*(cnk[8][0][2]*cnk[8][1][2]))+((.7153*(cnk[8][0][1]*cnk[8][1][1])
    ...
    temp[0] = ((((.0548*(Cik[3][0][2]*Cik[3][2][2]))+((.0825*(Cik[3][0][1]*
      ...
      (((1.3552*(cnk[8][0][2]*cnk[8][2][2]))+((.7153*(cnk[8][0][1]*cnk[8][2][1])
    ...
    temp[0] = (((11.15*((q[0]*q[0])+(q[2]*q[2])))+((.0548*(Cik[3][1][2]*
      ...
      ((1.3552*(cnk[8][1][2]*cnk[8][1][2]))+((.7153*(cnk[8][1][1]*cnk[8][1][1]))
    ...
    temp[0] = ((((.0548*(Cik[3][1][2]*Cik[3][2][2]))+((.0825*(Cik[3][1][1]*
      ...
      (((1.3552*(cnk[8][1][2]*cnk[8][2][2]))+((.7153*(cnk[8][1][1]*cnk[8][2][1])
    ...
    temp[0] = (((11.15*((q[0]*q[0])+(q[1]*q[1])))+((.0548*(Cik[3][2][2]*
      ...
      ((1.3552*(cnk[8][2][2]*cnk[8][2][2]))+((.7153*(cnk[8][2][1]*cnk[8][2][1]))
...
/*
Done. CPU seconds used: 20.30  Memory used: 1687552 bytes.
Equation complexity:
  sdstate:  2609 adds  3958 multiplies     1 divides  1556 assignments
  sdderiv: 67301 adds 73720 multiplies   867 divides 75313 assignments
  sdresid:  5663 adds  7305 multiplies     0 divides  2742 assignments
  sdreac:    862 adds   640 multiplies     0 divides   546 assignments
