 ...
 * Destructor.
 */
rdBodyConstraint::~rdBodyConstraint()
{
}
//______________________________________________________________________________
/**
 ...
 *
 * @param aID ID of this body constraint.
 */
void rdBodyConstraint::
setID(int aID)
{
	_id = aID;
}
 ...
 *
 * @return ID of this body constraint.
 */
int rdBodyConstraint::
getID()
{
...
constructConstraintsForPoint1()
{
	...
	double r1[3];
	rdMtx::Subtract(1,3,_pc[1].getPoint(),_pc[0].getPoint(),r1);
	...
	double c0[3],c1[3];
	rdMtx::CrossProduct(r1,cs,c0);
	rdMtx::CrossProduct(c0,r1,c1);
...
constructConstraintsForPoint2()
{
	// GET VECTOR FROM P0 to P1
	double r01[3],r12[3];
	rdMtx::Subtract(1,3,_pc[1].getPoint(),_pc[0].getPoint(),r01);
	rdMtx::Subtract(1,3,_pc[2].getPoint(),_pc[1].getPoint(),r12);

	// CONSTRAINT DIRECTIONS
	double c0[3];
	rdMtx::CrossProduct(r01,r12,c0);
	rdMtx::Normalize(3,c0,c0);
 ...
 */
double* rdBodyConstraint::
findMostOrthogonal(rdPointConstraint *aPC,double aV[3])
{
	// CORSS PRODUCTS
	double theta0 = fabs( rdMtx::Angle(aV,aPC->getC0()) );
	double theta1 = fabs( rdMtx::Angle(aV,aPC->getC1()) );
	double theta2 = fabs( rdMtx::Angle(aV,aPC->getC2()) );
