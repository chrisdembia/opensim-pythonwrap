 ...
 * class rdObject and is implemented as a wrapper around template
 * rdArrayPtrs<T>.  It is implemented around an array of pointers, rather
 ...
 */
template<class T> class rdSet : public rdObject
{
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// DATA
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
rdPropertyObjArray _propObjects;

// REFERENCES
rdArrayPtrs<T> &_objects;
 ...
 *
 * rdSet[size] = T[0] T[1] T[2] ... T[size-1].
 *
 * @param aOut Output stream.
 * @param aSet Set to be output.
 * @return Reference to the output stream.
 */
friend std::ostream& operator<<(std::ostream &aOut,const rdSet<T> &aSet)
{
	aOut << "rdSet[" << aSet.getSize() <<"] =";
 ...
 * @return True if the append was successful, false otherwise.
 */
virtual bool append(rdArrayPtrs<T> &aArray)
{
