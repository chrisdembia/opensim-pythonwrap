 ...
 * Destructor.
 */
rdPointConstraint::~rdPointConstraint()
{
}
//______________________________________________________________________________
/**
 * Constructor.
 */
rdPointConstraint::rdPointConstraint(int aID)
{
	clear();
	_id = aID;
}
 ...
 */
rdPointConstraint::
rdPointConstraint(double aP[3],double aV[3],
 ...
 */
int rdPointConstraint::
getNC()
{
	int nc = 0;
	if(rdMtx::Magnitude(3,_c0)!=0) nc++;
	if(rdMtx::Magnitude(3,_c1)!=0) nc++;
	if(rdMtx::Magnitude(3,_c2)!=0) nc++;
...
{
	double v[3];
	rdMtx::Subtract(1,3,aV,_v,v);
	double result = rdMtx::DotProduct(3,_c0,v);
	return(result);
}
//______________________________________________________________________________
/**
...
evaluateC1(double aV[3])
{
	double v[3];
	rdMtx::Subtract(1,3,aV,_v,v);
	double result = rdMtx::DotProduct(3,_c1,v);
	return(result);
}
//______________________________________________________________________________
/**
...
evaluateC2(double aV[3])
{
	double v[3];
	rdMtx::Subtract(1,3,aV,_v,v);
	double result = rdMtx::DotProduct(3,_c2,v);
	return(result);
}
...
constructOrthoNormalConstraints(double aV[3],double aC0[3])
{
	...
	setC0(aC0);  rdMtx::Normalize(3,_c0,_c0);
...
constructOrthoNormalC1(double aV[3])
{
	setC1(0.0,0.0,0.0);
	if(aV==NULL) return;
	rdMtx::CrossProduct(aV,_c0,_c1);
	rdMtx::Normalize(3,_c1,_c1);
}
//______________________________________________________________________________
/**
...
{
	setC2(0.0,0.0,0.0);
	rdMtx::CrossProduct(_c0,_c1,_c2);
	rdMtx::Normalize(3,_c2,_c2);
}
//______________________________________________________________________________
/**
