 ...
 */
rdPlane::rdPlane(double aPX,double aPY,double aPZ,
 ...
 * @param aNormal Unit vector normal to the plane.
 */
rdPlane::rdPlane(double aPX,double aPY,double aPZ,const double aNormal[3])
{
	setNull();
...
setNormal(const double aNormal[3])
{
	...
	// NORMALIZED
	double mag = rdMtx::Normalize(3,_normal,_normal);
 ...
 */
int rdPlane::
computeIntersection(const rdLine *aLine,double rPoint[3]) const
{
