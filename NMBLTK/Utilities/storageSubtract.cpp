...
int main(int argc,char **argv)
{
	...
	rdStorage *store1 = new rdStorage(store1Name);
	rdStorage *store2 = new rdStorage(store2Name);
	...
	if(size1!=size2) {
		printf("WARNING:	rdStorages have different number of rows.\n");
	}
